...
contract RouterIntegrationTMTest is Test, PackedRouteHelper {
    ...
    function test_SwapExactInTokenToToken() public {
        ...
        assertEq(IERC20(USDC).balanceOf(alice), 0, "test_SwapExactInTokenToToken::9");
        assertEq(IERC20(CHAMP).balanceOf(alice), totalOut, "test_SwapExactInTokenToToken::10");
    }
    ...
    function test_SwapExactOutTokenToToken() public {
        ...
        assertEq(IERC20(CHAMP).balanceOf(alice), maxAmountIn - totalIn, "test_SwapExactOutTokenToToken::9");
        assertEq(IERC20(USDC).balanceOf(alice), amountOut, "test_SwapExactOutTokenToToken::10");
    }
