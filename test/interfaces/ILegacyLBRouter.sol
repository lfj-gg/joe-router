...
/**
 * @title Legacy Liquidity Book Router Interface
 * @dev Interface of the V2.0 router contract.
 */
interface ILegacyLBRouter {
    ...
    function getSwapIn(address lbPair, uint256 amountOut, bool swapForY)
        external
        view
